...
while True:
    ...
    # Ver lista de enviados
        ...
        while True:
            ...
            if resposta == 'S':
                ...
                break
            print(
                f'{"NOME":>33}{"ASSUNTO":>20}{"EMAIL":>50}{"STATUS":>20}{"OBS":>30}')
    ...
    # Instruções
        ...
        print('     \033[31m--> IMPORTANTE: A senha para utilização é a senha para aplicativos.\033[m')
        ...
        print('     --> Insira o conteúdo do email. Você poderá digitar até dois parágrafos.')
